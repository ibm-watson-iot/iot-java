 ...
 *****************************************************************************
 */
package com.ibm.iotf.sample.gateway.home;
...
public class Oven extends Device {
	...
	/**
	 * The application sends a command to start/stop the cooking
	 */
	public void processCommand(String cmd) {
		
		if(this.bRunning == true) {
			// can not accept a command to start a new cooking process
			System.err.println(this.getDeviceId() +" is already running, so can not start a new cooking process");
			return;
		}
		try {

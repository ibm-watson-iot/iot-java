...
package com.ibm.iotf.sample.application;
...
import com.ibm.iotf.sample.gateway.HomeGatewaySample;
import com.ibm.iotf.sample.gateway.home.Device.DeviceType;
import com.ibm.iotf.sample.gateway.home.Oven.MODE;
...
public class HomeApplication {
	...
	private void createApplicationClient(String fileName) {
		...
		try {
			props.load(HomeApplication.class.getResourceAsStream(fileName));
		} catch (IOException e1) {
			System.err.println("Not able to read the application.properties file, exiting..");
			System.exit(-1);
		}

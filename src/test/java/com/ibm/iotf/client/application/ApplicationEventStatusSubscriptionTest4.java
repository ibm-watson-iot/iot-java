...
/**
 * This test verifies that the non-subscribed event will not be received by application. 
 *
 */
public class ApplicationEventStatusSubscriptionTest4 {
	...
	public void test01EventSubscribeJson() {
		...
		data.addProperty("work", true);
		testHelper.publishEvent("custom", null);

...
import com.ibm.iotf.test.common.handlers.TestDeviceActionHandler;
...
public class DeviceManagementTest6 {
	private static final String CLASS_NAME = DeviceManagementTest6.class.getName();
	...
	@Test
	public void test01RebootRequest() {
		final String METHOD = "test01RebootRequest";

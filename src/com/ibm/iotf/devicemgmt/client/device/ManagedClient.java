...
import com.ibm.iotf.devicemgmt.client.handler.DMRequestHandler;
import com.ibm.iotf.devicemgmt.client.listener.DMListener;
import com.ibm.iotf.util.LoggerUtility;

/**
 * Device Management Mqtt Client
 * 
 */

public class ManagedClient extends DeviceClient implements IMqttMessageListener{
	
	private static final String CLASS_NAME = ManagedClient.class.getName();
	...
	public ManagedClient(Properties options, DeviceData deviceData) throws Exception {
		super(options);

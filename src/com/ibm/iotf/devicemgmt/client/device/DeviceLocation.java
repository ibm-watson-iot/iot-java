...
import com.ibm.iotf.devicemgmt.client.device.DeviceFirmware.Builder;
...
import com.ibm.iotf.devicemgmt.client.device.Resource.DateResource;
...
public class DeviceLocation extends Resource {
	 ...
	 */
	public DeviceLocation(Builder builder) {
		super(RESOURCE_NAME);
